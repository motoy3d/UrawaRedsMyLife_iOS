...
static NSString * const kUrawaRedsMyLife_iOSJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_urawaredsmylife_iosInjection
{
	...
	[html appendString:kUrawaRedsMyLife_iOSJavascript];
...
{
	// attempt to make well-formed HTML and inject in our UrawaRedsMyLife_iOS bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _urawaredsmylife_iosInjection]];
