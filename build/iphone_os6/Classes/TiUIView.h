...
/**
 Base class for all UrawaRedsMyLife_iOS views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the UrawaRedsMyLife_iOS view hierarchy (such as wrapped iOS UIViews) was touched.
