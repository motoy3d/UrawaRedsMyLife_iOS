...
//Rare exceptions to indicate a bug in the _urawaredsmylife_ios code (Eg, function that a subclass should have implemented)
...
/**
 The base class for UrawaRedsMyLife_iOS proxies.
 */
