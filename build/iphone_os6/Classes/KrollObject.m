 ...
 * Copyright (c) 2009-2011 by UrawaRedsMyLife_iOS, Inc. All Rights Reserved.
...
//@interface UrawaRedsMyLife_iOSObject : NSObject
//@end

@interface UrawaRedsMyLife_iOSObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[UrawaRedsMyLife_iOSObject class]])
		{
			for (NSString *key in [[(UrawaRedsMyLife_iOSObject*)o modules] allKeys])
			{
