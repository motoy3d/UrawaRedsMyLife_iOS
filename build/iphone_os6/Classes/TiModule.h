...
/**
 The base class for all UrawaRedsMyLife_iOS modules
 */
...
/**
 UrawaRedsMyLife_iOS Platform calls this method on startup.
 */
-(void)startup;

/**
 UrawaRedsMyLife_iOS Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 UrawaRedsMyLife_iOS Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 UrawaRedsMyLife_iOS Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 UrawaRedsMyLife_iOS Platform calls this method on resume.
 @param sender The sender of the event.
 */
