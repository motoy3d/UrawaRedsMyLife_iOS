...
@interface UrawaRedsMyLife_iOSObject : KrollCoverageObject {
#else
@interface UrawaRedsMyLife_iOSObject : KrollObject {
#endif
@private
...
extern NSString * UrawaRedsMyLife_iOS$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	UrawaRedsMyLife_iOSObject *_urawaredsmylife_ios;
    KrollObject* console;
	BOOL shutdown;
